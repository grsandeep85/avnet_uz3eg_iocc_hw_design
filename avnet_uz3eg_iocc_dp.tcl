...
################################################################
# This is a generated script based on design: avent_uz3eg_iocc_dp
#
...
# source avent_uz3eg_iocc_dp_script.tcl
...
if { $list_projs eq "" } {
   create_project avent_uz3eg_iocc_dp avent_uz3eg_iocc_dp -part xczu3eg-sfva625-1-i
   set_property BOARD_PART em.avnet.com:ultrazed_eg_iocc_production:part0:1.0 [current_project]
}


# CHANGE DESIGN NAME HERE
set design_name avent_uz3eg_iocc_dp
...
make_wrapper -files [get_files ./avent_uz3eg_iocc_dp/avent_uz3eg_iocc_dp.srcs/sources_1/bd/avent_uz3eg_iocc_dp/avent_uz3eg_iocc_dp.bd] -top
add_files -norecurse ./avent_uz3eg_iocc_dp/avent_uz3eg_iocc_dp.srcs/sources_1/bd/avent_uz3eg_iocc_dp/hdl/avent_uz3eg_iocc_dp_wrapper.v
update_compile_order -fileset sources_1
update_compile_order -fileset sim_1
add_files -fileset constrs_1 -norecurse avnet_uz3eg_iocc_dp_constraints.xdc
#add_files -fileset constrs_1 -norecurse /group/bcapps/sandeepg/vivado-workspace/2017-2/Avnet-ultrazed/avnet_uz3eg_iocc_dp_constraints.xdc
#add_files -fileset constrs_1 -norecurse X:/vivado-workspace/2017-2/zu3-eg-ultrazed/test/avnet_uz3eg_iocc_dp_constraints.xdc
